            ...
            <div class="modal-content">
                <form action="#" method="post" id="formApprove">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Setujui Dana Donasi</h4>
                    </div>

                    <div class="modal-body">
                        <p id="del-success">Anda yakin ingin menyetujui Dana Donasi ini ?</p>
            ...
            <div class="modal-content">
                <form action="#" method="post" id="formReject">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Batalkan Dana Donasi</h4>
                    </div>

                    <input type="hidden" id="id" name="id" value="{{ $data->id }}">

                    <div class="modal-body">
                        <p id="del-success">Anda yakin ingin membatalkan Dana Donasi ini ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
                            Tidak
    ...
    <script>
        jQuery(document).ready(function($){
            ...
            $('#btnApprove').click(function () {
                url = '{{ route("admin.dana-donation.approve") }}';
            ...
            $('#btnReject').click(function () {
                url = '{{ route("admin.dana-donation.reject") }}';
